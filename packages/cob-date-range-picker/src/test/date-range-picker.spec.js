...
const dateRangePickerSelector = () =>
  document.querySelector(".cob-date-range-picker");
const tests = [
...
tests.forEach(({ name, selector: containerSelector }) => {
  describe(`date range picker component initialized at ${name}`, () => {
    ...
    beforeEach(() => {
      ...
      rangeStart = root.querySelector(".cob-date-range-picker__range-start");
      rangeEnd = root.querySelector(".cob-date-range-picker__range-end");
      rangeStartInputEl = rangeStart.querySelector(
        ".cob-date-picker__external-input",
      );
