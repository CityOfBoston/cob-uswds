...
const DatePicker = require("../../../cob-date-picker/src/index");
...
describe("Date range picker button without wrapping element", () => {
  ...
  beforeEach(() => {
    ...
    rangeStartInputEl = body.querySelector(
      ".cob-date-range-picker__range-start .cob-date-picker__external-input",
    );
    rangeEndInputEl = body.querySelector(
      ".cob-date-range-picker__range-end .cob-date-picker__external-input",
    );
    expectedError = "";
  ...
  it('should throw an error when the range start value is changed without a wrapping "cob-date-range-picker"', () => {
    expectedError = "Element is missing outer .cob-date-range-picker";
    rangeStartInputEl.value = "12/12/2020";
    EVENTS.input(rangeStartInputEl);
    assert.strictEqual(error, expectedError, "caught the error");
  });

  it('should throw an error when the range end value is changed without a wrapping "cob-date-range-picker"', () => {
    expectedError = "Element is missing outer .cob-date-range-picker";
