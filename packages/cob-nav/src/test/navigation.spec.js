...
const navigation = require("../../../cob-header/src/index");
const accordion = require("../../../cob-accordion/src/index");
...
describe("navigation toggle", () => {
  ...
  beforeEach(() => {
    ...
    accordion.on();
    navigation.on();
    header = body.querySelector(".cob-header");
    nav = body.querySelector(".cob-nav");
    navControl = body.querySelector(".cob-nav__link");
    overlay = body.querySelector(".cob-overlay");
    closeButton = body.querySelector(".cob-nav__close");
    menuButton = body.querySelector(".cob-menu-btn");
    accordionButton = nav.querySelector(".cob-accordion__button");
