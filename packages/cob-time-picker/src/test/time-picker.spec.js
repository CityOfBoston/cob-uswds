...
const ComboBox = require("../../../cob-combo-box/src/index");
const EVENTS = require("../../../cob-combo-box/src/test/events");

const TEMPLATE = fs.readFileSync(
  path.join(__dirname, "/time-picker.template.html"),
);

const timePickerSelector = () => document.querySelector(".cob-time-picker");
const tests = [
...
tests.forEach(({ name, selector: containerSelector }) => {
  describe(`time picker component initialized at ${name}`, () => {
    ...
    beforeEach(() => {
      ...
      root = body.querySelector(".cob-combo-box");
