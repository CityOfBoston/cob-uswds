...
describe("language selector component", () => {
  ...
  beforeEach(() => {
    ...
    language = body.querySelector(".cob-language-container");
    languageList = body.querySelector(".cob-language__submenu");
    languageButton = body.querySelector(".cob-language__link");
