...
const tests = [
  ...
  {
    name: "combo box",
    selector: () => document.querySelector(".cob-combo-box"),
  },
];
  ...
  describe(`Combo box initialized at ${name}`, () => {
    describe("combo box component", () => {
      ...
      beforeEach(() => {
        ...
        ComboBox.on(root);
        input = root.querySelector(".cob-combo-box__input");
        toggle = root.querySelector(".cob-combo-box__toggle-list");
        select = root.querySelector(".cob-combo-box__select");
        status = root.querySelector(".cob-combo-box__status");
        list = root.querySelector(".cob-combo-box__list");
      });
      ...
      it("enhances a select element into a combo box component", () => {
        ...
        assert.ok(
          select.classList.contains("cob-sr-only"),
        ...
        assert.ok(
          select.classList.contains("cob-combo-box__select"),
      ...
      it("should focus the first item in the list when pressing down from the input", () => {
        ...
        assert.ok(
          focusedOption.classList.contains(
            "cob-combo-box__list-option--focused",
          ),
