...
const EXPANDED_CLASS = "cob-banner__header--expanded";
const HIDDEN = "hidden";

const tests = [
  { name: "document.body", selector: () => document.body },
  { name: "banner", selector: () => document.querySelector(".cob-banner") },
];
...
tests.forEach(({ name, selector: containerSelector }) => {
  describe(`Banner initialized at ${name}`, () => {
    ...
    beforeEach(() => {
      ...
      header = body.querySelector(".cob-banner__header");
      button = body.querySelector(".cob-banner__button");
      content = body.querySelector(".cob-banner__content");
