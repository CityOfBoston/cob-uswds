...
const PRIMARY_CONTENT_SELECTOR =
  ".cob-footer--big .cob-footer__primary-content--collapsible .cob-list";
const BUTTON_SELECTOR = ".cob-footer__primary-link";
...
const tests = [
  ...
  { name: "footer", selector: () => document.querySelector(".cob-footer") },
];
