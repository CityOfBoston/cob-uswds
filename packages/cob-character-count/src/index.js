...
const debounce = require("../../bwds-core/src/js/utils/debounce");
...
/**
 * Move maxlength attribute to a data attribute on cob-character-count
 *
 * @param {HTMLInputElement|HTMLTextAreaElement} inputEl The character count input element
 */
 ...
 *
 * @param {HTMLDivElement} characterCountEl - Div with `.cob-character-count` class
...
const createStatusMessages = (characterCountEl) => {
  ...
  statusMessage.classList.add(`${STATUS_MESSAGE_CLASS}`, "cob-hint");
...
const enhanceCharacterCount = (inputEl) => {
  ...
  messageEl.classList.add("cob-sr-only");
