...
const STYLES = fs.readFileSync(
  `${__dirname}/../../../../dist/css/bwds.min.css`,
);
const THE_NAV = ".cob-in-page-nav";
const PRIMARY_CONTENT_SELECTOR =
  ".cob-in-page-nav-container .cob-in-page-nav .cob-in-page-nav__list";
...
const tests = [
  ...
  {
    name: "in page nav",
    selector: () => document.querySelector(".cob-in-page-nav"),
  },
];
...
tests.forEach(({ name, selector: containerSelector }) => {
  describe(`in-page navigation initialized at ${name}`, () => {
    ...
    it("assigns id to section headings", () => {
      ...
      const ok = [
        "h2 > .cob-anchor#section-1",
        "h2 ~ h3 > .cob-anchor#section-1-1",
        "h2 ~ h3 ~ h3 > .cob-anchor#section-1-2-2",
        "h2 ~ h3 ~ h3 ~ h3 > .cob-anchor#section-1-3",
        "h2 ~ h3 ~ h3 ~ h3 ~ h3 > .cob-anchor[id='1-4-section-1-4']",
