...
const tests = [
  ...
  { name: "tooltip", selector: () => document.querySelector(".cob-tooltip") },
];
...
tests.forEach(({ name, selector: containerSelector }) => {
  describe(`tooltips initialized at ${name}`, () => {
    ...
    beforeEach(() => {
      ...
      tooltipBody = body.querySelector(".cob-tooltip__body");
      tooltipTrigger = body.querySelector(".cob-tooltip__trigger");
      tooltipWrapper = body.querySelector(".cob-tooltip");
    });
    ...
    it("trigger is created", () => {
      assert.strictEqual(
        ...
        "cob-button cob-tooltip__trigger",
      );
    });
    ...
    it("should not allow for innerHTML of child elements ", () => {
      ...
      body.innerHTML = `<button class="cob-button cob-tooltip" title="Apricot &lt;img src='' onerror=alert('ouch')&gt;">Button</button>`;
      tooltip.on();
      tooltipBody = body.querySelector(".cob-tooltip__body");
      tooltipTrigger = body.querySelector(".cob-tooltip__trigger");
      tooltip.on(body);
