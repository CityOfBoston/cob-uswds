...
const modalWindowSelector = () => document.querySelector(".cob-modal");
...
tests.forEach(({ name, selector: containerSelector }) => {
  describe(`Modal window initialized at ${name}`, () => {
    ...
    beforeEach(() => {
      ...
      modalWrapper = body.querySelector(".cob-modal-wrapper");
      overlay = body.querySelector(".cob-modal-overlay");
      openButton1 = openButton1Selector();
      openButton2 = openButton2Selector();

      comboList = comboListSelector();
      comboBoxToggleButton = body.querySelector(".cob-combo-box__toggle-list");
    });
    ...
    describe("Builds the modal HTML", () => {
      ...
      it("moves the modal to the bottom of the DOM", () => {
        assert.strictEqual(
          body.lastElementChild.classList.contains("cob-modal-wrapper"),
          true,
        );
      });
