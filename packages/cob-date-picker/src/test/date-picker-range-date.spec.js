...
tests.forEach(({ name, selector: containerSelector }) => {
  describe(`date picker component with range date initialized at ${name}`, () => {
    ...
    it("should display the range date when showing the month of the range date", () => {
      ...
      assert.strictEqual(
        getCalendarEl(".cob-date-picker__calendar__date--range-date").dataset
          .value,
        "2020-05-22",
    ...
    it("should not display the range date when showing the a month different from the range date month", () => {
      ...
      assert.strictEqual(
        getCalendarEl(".cob-date-picker__calendar__date--range-date"),
        null,
    ...
    it("should display the days between the calendar date and the range date as within range when the calendar date is above the range date", () => {
      ...
      assert.strictEqual(
        ...
        ).classList.contains("cob-date-picker__calendar__date--within-range"),
        false,
        "should not show the range date as within range",
      );
      assert.strictEqual(
        getCalendarEl(
          '.cob-date-picker__calendar__date[data-day="23"]',
        ).classList.contains("cob-date-picker__calendar__date--within-range"),
        true,
      ...
      assert.strictEqual(
        getCalendarEl(
          '.cob-date-picker__calendar__date[data-day="24"]',
        ).classList.contains("cob-date-picker__calendar__date--within-range"),
        true,
        "shows date within range as within range",
      );
      ...
      assert.strictEqual(
        getCalendarEl(
          '.cob-date-picker__calendar__date[data-day="26"]',
        ).classList.contains("cob-date-picker__calendar__date--within-range"),
        false,
    ...
    it("should display the days between the calendar date and the range date as within range when the calendar date is below the range date", () => {
      ...
      assert.strictEqual(
        getCalendarEl(
          '.cob-date-picker__calendar__date[data-day="21"]',
        ).classList.contains("cob-date-picker__calendar__date--within-range"),
        true,
        "shows date within range as within range",
      );
      ...
      assert.strictEqual(
        getCalendarEl(
          '.cob-date-picker__calendar__date[data-day="19"]',
        ).classList.contains("cob-date-picker__calendar__date--within-range"),
        true,
        "shows date within range as within range",
      );
      assert.strictEqual(
        getCalendarEl(
          '.cob-date-picker__calendar__date[data-day="18"]',
        ).classList.contains("cob-date-picker__calendar__date--within-range"),
        false,
        "should not show the current calendar date as within range",
      );
      assert.strictEqual(
        getCalendarEl(
          '.cob-date-picker__calendar__date[data-day="17"]',
        ).classList.contains("cob-date-picker__calendar__date--within-range"),
        false,
        "does not show dates outside of the range as within range",
      );
