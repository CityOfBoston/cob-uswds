...
const datePickerSelector = () => document.querySelector(".cob-date-picker");
const tests = [
...
tests.forEach(({ name, selector: containerSelector }) => {
  describe(`date picker component with min date and max date initialized at ${name}`, () => {
    ...
    const getCalendarEl = (query) =>
      root.querySelector(
        `.cob-date-picker__calendar${query ? ` ${query}` : ""}`,
      );
    ...
    beforeEach(() => {
      ...
      input = root.querySelector(".cob-date-picker__external-input");
      button = root.querySelector(".cob-date-picker__button");
      expectedError = "";
    ...
    it("should allow navigation back a year to a month that is partially disabled due to a minimum date being set", () => {
      ...
      EVENTS.click(getCalendarEl(".cob-date-picker__calendar__previous-year"));

      assert.strictEqual(
        getCalendarEl(".cob-date-picker__calendar__date--focused").dataset
          .value,
        "2020-05-22",
    ...
    it("should disable back buttons when displaying the minimum month", () => {
      ...
      assert.strictEqual(
        getCalendarEl(".cob-date-picker__calendar__previous-month").disabled,
        true,
        "the previous month button is disabled",
      );
      assert.strictEqual(
        getCalendarEl(".cob-date-picker__calendar__previous-year").disabled,
        true,
        "the previous year button is disabled",
      );

      EVENTS.click(getCalendarEl(".cob-date-picker__calendar__previous-month"));
      EVENTS.click(getCalendarEl(".cob-date-picker__calendar__previous-year"));
    ...
    it("should disable forward buttons when displaying the maximum month", () => {
      ...
      assert.strictEqual(
        getCalendarEl(".cob-date-picker__calendar__next-month").disabled,
        true,
        "the next month button is disabled",
      );
      assert.strictEqual(
        getCalendarEl(".cob-date-picker__calendar__next-year").disabled,
        true,
        "the next year button is disabled",
      );

      EVENTS.click(getCalendarEl(".cob-date-picker__calendar__next-month"));
      EVENTS.click(getCalendarEl(".cob-date-picker__calendar__next-year"));
    ...
    it("should allow selection of a month in the month selection screen that is partially disabled due to a minimum date being set", () => {
      ...
      EVENTS.click(button);
      EVENTS.click(
        getCalendarEl(".cob-date-picker__calendar__month-selection"),
      );
      assert.ok(
        getCalendarEl(".cob-date-picker__calendar__month-picker"),
        "the month picker is shown",
      );

      EVENTS.click(
        getCalendarEl().querySelector(
          '.cob-date-picker__calendar__month[data-label="May"]',
        ),
      );
      ...
      assert.ok(
        getCalendarEl(".cob-date-picker__calendar__date-picker"),
    ...
    it("should not allow selection of a month in the month selection screen that is fully disabled due to a minimum date being set", () => {
      ...
      EVENTS.click(
        getCalendarEl(
          '.cob-date-picker__calendar__month[data-label="January"]',
        ),
      );
    ...
    it("should allow selection of a month in the month selection screen that is partially disabled due to a maximum date being set", () => {
      ...
      EVENTS.click(
        getCalendarEl().querySelector(
          '.cob-date-picker__calendar__month[data-label="June"]',
        ),
      );
    ...
    it("should not allow selection of a month in the month selection screen that is fully disabled due to a maximum date being set", () => {
      ...
      EVENTS.click(
        getCalendarEl(
          '.cob-date-picker__calendar__month[data-label="December"]',
        ),
      );
    ...
    it("should allow selection of a year in the year selection screen that is partially disabled due to a minimum date being set", () => {
      ...
      EVENTS.click(button);
      EVENTS.click(getCalendarEl(".cob-date-picker__calendar__year-selection"));
      assert.ok(
        getCalendarEl(".cob-date-picker__calendar__year-picker"),
        "the year picker is shown",
      );

      EVENTS.click(
        getCalendarEl('.cob-date-picker__calendar__year[data-value="2020"]'),
      );
    ...
    it("should allow selection of a year in the year selection screen that is partially disabled due to a maximum date being set", () => {
      ...
      EVENTS.click(
        getCalendarEl('.cob-date-picker__calendar__year[data-value="2021"]'),
      );
    ...
    it("should not allow selection of a year in the year selection screen that is fully disabled due to a minimum date being set", () => {
      ...
      EVENTS.click(
        getCalendarEl('.cob-date-picker__calendar__year[data-value="2018"]'),
      );
    ...
    it("should not allow selection of a year  in the year selection screen that is fully disabled due to a maximum date being set", () => {
      ...
      EVENTS.click(
        getCalendarEl('.cob-date-picker__calendar__year[data-value="2023"]'),
      );
    ...
    it("should allow selection of a date that is the minimum date", () => {
      ...
      EVENTS.click(
        getCalendarEl().querySelector(
          '.cob-date-picker__calendar__date[data-day="22"]',
        ),
      );
    ...
    it("should allow selection of a date that is the maximum date", () => {
      ...
      EVENTS.click(
        getCalendarEl().querySelector(
          '.cob-date-picker__calendar__date[data-day="20"]',
        ),
      );
    ...
    it("should not allow selection of a date that is before the minimum date", () => {
      ...
      EVENTS.click(
        getCalendarEl().querySelector(
          '.cob-date-picker__calendar__date[data-day="15"]',
        ),
      );
    ...
    it("should not allow selection of a date that is after the maximum date", () => {
      ...
      EVENTS.click(
        getCalendarEl().querySelector(
          '.cob-date-picker__calendar__date[data-day="25"]',
        ),
      );
