...
const toggle = require("../../bwds-core/src/js/utils/toggle");
const FocusTrap = require("../../bwds-core/src/js/utils/focus-trap");
const accordion = require("../../cob-accordion/src/index");
const ScrollBarWidth = require("../../bwds-core/src/js/utils/scrollbar-width");
...
const ACTIVE_CLASS = "cob-js-mobile-nav--active";
 ...
 * More details in https://github.com/bwds/bwds/pull/5443
 */
