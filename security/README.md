This `/security` directory contains SHA-256 hashes for each BWDS hashed release ZIP file. Use these hashes to verify the authenticity of BWDS release ZIP files. Compare our SHA-256 hash with the hash you generate from the ZIP you wish to test.
